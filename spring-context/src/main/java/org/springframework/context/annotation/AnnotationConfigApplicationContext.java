...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	/**
	 * Create a new AnnotationConfigApplicationContext that needs to be populated 创建一个需要填充的新AnnotationConfigApplicationContext
	...
	public AnnotationConfigApplicationContext(Class<?>... componentClasses) {
		// 1.初始化bean读取器和扫描器;
		/**
		 * 调用父类 GenericApplicationContext 无参构造函数，初始化一个BeanFactory: DefaultListableBeanFactory beanFactory = new DefaultListableBeanFactory()
		 * DefaultListableBeanFactory类中调用父类构造方法 AbstractAutowireCapableBeanFactory()
		 * AbstractAutowireCapableBeanFactory类
		 * 往一个忽略接口的set集合中添加了三个接口 	BeanNameAware BeanFactoryAware BeanClassLoaderAware
		 * 确定了Bean的生成策略 CglibSubclassingInstantiationStrategy this.instantiationStrategy = new CglibSubclassingInstantiationStrategy();
		 * 调用自己的构造
		 */
		this();
		/**
